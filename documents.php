		...
		<div class="portal-container dash-container">
			...
			<div class="row">
				<div id="agreements" class="container" style="padding-top:0;">
			        <div class="row">
						<?
						if($customer->documents !== false && sizeof($customer->documents)>0){
						?>
					            ...
					            <tbody>
						            ...
						            <tr>
							            <td class="main" data-column="Title">
								            <a href="<?=AWS."/documents/".$doc->fileName?>"><strong><?=strlen($doc->title)>1 ? $doc->title : "No document title provided"?></strong></a>
										</td>
										<td data-column="Description"><?=$doc->description?></td>
							            <td data-column="Status">
								            <a href="<?=AWS."/documents/".$doc->fileName?>">Download</a>
							            </td>
									</tr>
									<?
									}
						...
						<div class="row">
							<div class="module">
					            <div class="none documents" style="margin-top: 4em;">
					                <p>You have no documents available to download.</p>
					            </div>
							</div>
						</div>
						<?
