...
})(window,document,'script','dataLayer','GTM-MHS8SBK');</script>
<!-- End Google Tag Manager -->

<script src="https://kit.fontawesome.com/70f47d4482.js" crossorigin="anonymous"></script>

<script>
window['_fs_debug'] = false;
window['_fs_host'] = 'fullstory.com';
window['_fs_script'] = 'edge.fullstory.com/s/fs.js';
window['_fs_org'] = 'BM1PX';
